...
a persistence unit "ExamenJarroXavierServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenJarroXavierServidor\pom.xml":
...
artifact ("ExamenJarroXavierServidor.war") is already built. You can build
